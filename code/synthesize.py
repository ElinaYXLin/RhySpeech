...
def synthesize(model, step, configs, vocoder, batchs, control_values):
    ...
    pitch_control, energy_control, duration_control, pause_control = control_values
        ...
        with torch.no_grad():
            ...
            output = model(
                *(batch[2:]),
                ...
                r_control=pause_control # r for rhythm
            )
...
if __name__ == "__main__":
    ...
    control_values = args.pitch_control, args.energy_control, args.duration_control, args.duration_control
